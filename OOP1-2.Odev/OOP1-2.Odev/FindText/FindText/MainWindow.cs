...
namespace FindText
{
    ...
    public partial class MainWindow : Window   
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            //Oluşan nesneyi tekrar çağırıyoruz
            Singleton nesne2 = Singleton.Getinstance();
           
           //Test kısmı
            //nesne1 ile nesne2'nin aynı olup olmadığını kontrol ediyoruz.
            if (nesne1 == nesne2)
            {
                MessageBox.Show("Testten Geçti");
            }
            else
            {
                MessageBox.Show("Nesneler aynı değil");
            }
        }
    }
}